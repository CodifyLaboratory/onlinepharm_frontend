...
function Ordering({ navigation }) {
    const [deliveryOptionsValue, setDeliveryOptionsValue] =
        React.useState('Яндекс Такси')
    const [paymentMethodsValue, setPaymentMethodsValue] = React.useState(
            ...
            <View style={ordering.container}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ marginRight: 40 }}>
                        <Text style={[ordering.label, { marginBottom: 0 }]}>
                            Срок доставки:
                        </Text>
                        <Text style={[ordering.title, { marginTop: 16 }]}>
