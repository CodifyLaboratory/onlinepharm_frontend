...
import {View, StyleSheet, Text, SafeAreaView, Platform, TouchableOpacity} from "react-native";
...
const Search = ({navigation}) => {
  ...
  useEffect(() => {
    Api.getData(`medications/?search=${searchValue}`)
      .then(res => searchValue.length > 0 ? setSearchData(res.data) : setSearchData([]))
  ...
  return (
    <SafeAreaView>
      <View style={search.container}>
        ...
        </View> : <View style={search.searchLogo}>
          <SearchImg style/>
