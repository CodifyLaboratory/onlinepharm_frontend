...
export let strings = new LocalizedStrings({
    ru: {
        ...
        validation: {
            ...
            wrong_credentials: 'Email или пароль неверны',
    ...
    kg: {
        ...
        validation: {
            wrong_email: 'Туура эмес email',
            wrong_code: 'Tуура эмес код',
            field_is_required: 'Милдеттүү талаа',
            wrong_credentials: 'Email же сырсөз туура эмес',
